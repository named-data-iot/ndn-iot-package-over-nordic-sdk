#!/bin/sh
#
# Unified Segger JLink script for NDN-Lite
#
# This script is supposed to be called from NDN-Lite make system,
...
_JLINK_TERMPROG=../../third-party/pyterm/pyterm
...
do_flash() {
    ...
    cat ../../third-party/jlink/reset.seg >> ${BINDIR}/burn.seg
